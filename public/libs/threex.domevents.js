...
//   * DONE bubbling implement bubbling/capturing
...
// # Supported Events
//
// Always in a effort to stay close to usual practices, the events name are the same as in DOM.
...
// It is a global class, so it may be legitimately considered unclean by some people.
...
DomEvents.prototype.bind = function (object3d, eventName, callback, useCapture) {
  console.assert(
    DomEvents.eventNames.indexOf(eventName) !== -1,
...
DomEvents.prototype._onMouseDown = function (event) {
  return this._onMouseEvent("mousedown", event);
};
DomEvents.prototype._onMouseUp = function (event) {
